	...
	<div id = "project">
		<div id = "project_list">	
			...
			<ul id="list_sortable">  
					<?php
						foreach($list as $key){
							echo "<li class=\"ui-state-default\">".$key["title"]."<span id=\"list_".$key["id"]."\" style=\"cursor:pointer;margin-right:-10px;\" class='listDelete'><img src=\"".$img_path."/delete.png\"></span></li>";
						}
					?>
			</ul>
			</div>
