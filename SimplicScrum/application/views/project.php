				...
				<?php
					if(isset($backlog["sprintlog"])){
						...
						foreach($backlog["sprintlog"] as $key){
							$str .= "<div id=\"pList_".$key->id."\" class=\"sbacklog_list nlClass\"><div id='no' style='font-weight:bold; display:inline; padding:8px; margin-left:5px'>NO:</div><div id='no_box' style=' display:inline;'>".$key->id."(".$key->btitle.")</div><div style='width:100px; display:inline; margin-left:32px; font-weight: bold'>TITLE:</div><div class='title' style='width:100px; display:inline; padding:2px; border-bottom:1px solid; font-size:13px; margin-left:6px'>".word_limiter($key->title,3)."</div><a href =# style='font-size:8px; display:inline;'>vote</a></div><div style='font-size:8px; display:inline;'>0</div>";
