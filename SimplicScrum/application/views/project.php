				...
				<?php
					if(isset($backlog["porduct"])){
						...
						foreach($backlog["porduct"] as $key){
							$str .= "<div id='no' style='font-weight:bold; display:inline; padding:5px'>NO:</div><div id='no_box' style=' display:inline'>$key->pd_id</div><div id=\"pList_".$key->pd_id."\" class=\"pbacklog_list nlClass\"><div style='width:100px; display:inline; margin:10px; font-weight: bold'>TITLE:</div><div class='title' style='width:100px; display:inline; padding:5px;'>".$key->pd_title."</div>";
