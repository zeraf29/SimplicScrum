				...
				<?php
					if(isset($backlog["sprintlog"])){
						...
						foreach($backlog["sprintlog"] as $key){
							...
							$str .= "<div class='bContent'><div style='font-weight:bold; margin-left:8px'>Full Title:</div><div style = 'width:270px; font-size:10 margin-top:15px border:1px solid; background:white; margin-left:8px'>".$key->title."</div><div style='font-weight:bold; margin-left:8px'>DESCRIPTION:</div><div style = 'width:268px; height:90px; font-size:10 margin-top:15px border:1px solid; background:white; margin-left:8px'><textarea style='height:90px;width:268px;' readonly>".$key->sdesc."</textarea></div><div style='display:inline; margin-left:9px; font-size:12px; font-weight:bold'>Level:</div><div style='display:inline; margin-left:6px; font-size:11px'>level(0, 1, 2)</div><div style='display:inline'><a href = '#' style='display:inline; margin-left:86px; font-size:8px'>MODIFY</a></div></div></div>";
							$cnt++;
						}
						echo $str;
					}
